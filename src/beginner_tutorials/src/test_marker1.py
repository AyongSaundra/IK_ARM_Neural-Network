...
def publish_joint(pub1, pub2, pub3, pub4, pub5, pub6, joints, rate):
...
def main():
    ...
    a,b,c,d = cekError(f_eff,predict_f_eff)
    # print("error avg :", a)
    # print("error list :", b)
    # print("error pos m:", c)
    print("error pos (cm): ", c*100)
    print("error rot :", d)
    c = c*100
    
    while not rospy.is_shutdown():
        publish_joint(pub1, pub2, pub3, pub4, pub5, pub6, joints, rate)
        if c <= 1 or d <= 0.1:
